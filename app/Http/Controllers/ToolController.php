...
class ToolController extends Controller
{
    ...
    public function index_iframe()
    {
        ...
        return view('tool.index_iframe', compact('products', 'technician', 'manufacture', 'product'));
    }
    ...
    public function iframecreateproduct()
    {
        $manufacture = Manufacturer::all();
        $product = ProductCategory::get();
        $technicians = User::where('role', 'technician')->where('status', 'active')->get();
        return view('tool.create_tool_iframe', compact('product', 'manufacture', 'technicians'));
    }
    public function iframe_edit($id)
    {
        ...
        return view('tool.iframe_edit_tool', compact('product', 'manufacture', 'productCategories', 'Color', 'Sizes', 'material', 'weight', 'technicians', 'selectedTechnicians'));
    }
    ...
    public function iframe_assign_product(Request $request)
    {
        ...
        return view('tool.tool_assign_iframe', compact('technician', 'technician1', 'product', 'assign'));
    }
    ...
    public function store_iframe_assign_tool(Request $request)
    {
        //dd($request->all());
        // Retrieve the product IDs and technician IDs from the request
        $productIds = $request->input('product_id');
