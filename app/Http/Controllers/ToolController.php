...
class ToolController extends Controller
{
       public function index()
    {
        ...
        $products = Tool::orderBy('created_at', 'desc')->get();

        $manufacture = Manufacturer::all();
        $product = ProductCategory::get();

        return view('tool.index', compact('products', 'manufacture', 'product'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($assignedTo === 'all') {
            ...
            return redirect()->route('tool.index', ['product_id' => $productCategoryId])
