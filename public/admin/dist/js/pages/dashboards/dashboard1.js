...
$(function () {
  ...
  var sales_summery = {
    series: [
      {
        name: "New Customers 2022",
        data: [9, 12, 20, 21, 29, 30, 46, 52, 60, 66],
      },
      {
        name: "New Customers 2023",
        data: [15, 24, 26, 29, 36, 45, 56, 68, 80, 94],
      },
    ],
    chart: {
    ...
    xaxis: {
      categories: ["Jan", "Feb", "Mar", "Apr", "May", "June", "Jul", "Aug", "Sept", "Oct"],
      labels: {
        style: {
          colors: [
            "#a1aab2",
