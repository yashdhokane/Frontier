                    ...
                    <div class="card-body border-top">
						...
						<div class="row">
						 ...
						 <div class="row">
							...
							<div class="col-sm-12 col-md-12">
								<div class="mb-3">
									<label for="address_unit" class="control-label bold mb5 col-form-label ">Address Line
										2</label>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label mb-2" for="service_areas{{ $area->area_id }}"
                                            style="width: 100%;">
  ...
  <!--  <div class="row">
            ...
            foreach ($colors as $val_color_code) {
                echo  '<div class="col-sm-12 col-md-4">
                    <div class="form-check">
                        <input class="form-check-input success check-outline outline-success" type="radio" name="color_code" id="'.$val_color_code.'" value="'.$val_color_code.'">
                        <label class="form-check-label" for="'.$val_color_code.'"><div class="color_box" style="background-color: #'.$val_color_code.';"></div></label>
                    </div>
                </div>';
            }
            ?>
