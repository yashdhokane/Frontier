                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="https://gaffis.in/frontier/website/technicians">Technician</a>
                            </li>
...
<h6>{{ $technician->created_at ? \Carbon\Carbon::parse($technician->created_at)->format('m-d-Y') : null }}</h6>
                            ...
                            <div class="col-12">
                                ...
                                <h6 style="font-weight: normal;"><i class="fas fa-mobile-alt"></i> {{$technician->mobile}}
                                </h6>
                                {{-- <h6 style="font-weight: normal;"><i class="fas fa-mobile-alt"></i> +1 123 456 7890
                                </h6> --}}
                                <h6 style="font-weight: normal;"><i class="fas fa-envelope"></i> {{$technician->email}}</h6>
                            </div>
                            <div class="col-12">
            ...
            <div class="card-body">
                <center class="mt-1">
                    @if($technician->user_image)
                        <img src="{{ asset('public/images/technician/' . $technician->user_image) }}" class="rounded-circle" width="150" />
                    @else
                        <img src="{{ asset('public/images/login_img_bydefault.png') }}" alt="avatar" class="rounded-circle" width="150" />
                    @endif
                    <h4 class="card-title mt-1">{{ $technician->name }}</h4>
                  {{--  <h6 class="card-subtitle">{{ $technician->company ?? null }}</h6> --}}
                </center>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                ...
                <p><i class="fas fa-file-alt"></i></p>
                    <img src="{{ asset('storage/app/' . $image->filename) }}" alt="Customer Image"
                        style="width: 50px; height: 50px;">
                </a>
                @else
                <!-- Default image if no image available -->
                <img src="{{ asset('https://gaffis.in/frontier/website/public/admin/assets/images/users/1.jpg') }}" alt="Default Image" style="width: 50px; height: 50px;">
                @endif
            </div>
            @endforeach
        </div>
                                ...
                                <div class="tab-pane fade" id="calls_tab" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-4">
                                            <table id="zero_config" class="table table-bordered text-nowrap">
                                                ...
                                                @foreach($jobasign as $customercall)
                                                    <tr>
                                                        <td><span
                                                                class="badge bg-light-warning text-warning font-medium">In
                                                                Progress</span></td>
                                                        <td><a href="#"
                                                                class="font-medium link">{{$customercall->assign_title ?? null}}</a><br />
                                                        </td>
                                                        <td><a href="#" class="fw-bold link">{{$customercall->id ?? null}}</a>
                                                        </td>
                                                        <td>{{ \Carbon\Carbon::parse($customercall->created_at)->format('m-d-y') }}</td>
                                                       <td>
                                                        @php
                                                           $technician = DB::table('users')->where('id', $customercall->technician_id)->first();
                                                          @endphp
                                ...
                                <div class="tab-pane fade" id="payment_tab" role="tabpanel"
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <button type="button"
                                                                        ...
                                                                        aria-expanded="false">
                                                                        <i
                                                                            class="ri-settings-3-fill align-middle fs-5"></i>
                                                                    </button>
                                ...
                                <div class="tab-pane fade show " id="others_tab" role="tabpanel"
                                    ...
                                    <div class="card-body">
                                        <div class="profiletimeline mt-0">
                                            ...
                                            <div class="sl-item">
                                                <div class="sl-left">
                                                    <img src="https://gaffis.in/frontier/webapp/design/assets/public/images/users/3.jpg"
                                                        alt="user" class="rounded-circle" />
                                                </div>
                                                <div class="sl-right">
                                                    <div>
                                            ...
                                            <div class="sl-item">
                                                <div class="sl-left">
                                                    <img src="https://gaffis.in/frontier/webapp/design/assets/public/images/users/4.jpg"
                                                        alt="user" class="rounded-circle" />
                                                </div>
                                                <div class="sl-right">
                                                    <div>
