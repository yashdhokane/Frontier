                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="pull-right text-end">
                                        <address>
                                            <h6 class="mb-2"><b>Invoice Date:</b>
                                                {{ $convertDateToTimezone($payment->issue_date) }}</h6>
                                            <h6 class="mb-2"><b>Due Date: </b>
                                                {{ $convertDateToTimezone($payment->due_date) }}</h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="font-weight-medium mb-0">
                                                                ...
                                                                <small
                                                                    class="text-muted">{{ $service->service->warranty_type ?? null }}</small>
                                                            </h6>
                                                        </td>
