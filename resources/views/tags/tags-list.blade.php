                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm edit-btn" data-bs-toggle="modal"
                                        data-bs-target="#samedata-modal2" data-tag-id="{{ $tag->tag_id }}"
                                        data-tag-name="{{ $tag->tag_name }}">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <a href="{{ url('/delete/tags/' . $tag->tag_id) }}"
                                        onclick="confirm('Are you sure you want to delete tag?')"><button type="button"
                    ...
                    <form action="{{ url('/edit/tags') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tag1" name="tag_name" value="" />
                            </div>
