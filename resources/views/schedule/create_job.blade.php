                          ...
                          <form action="#" class="tab-wizard vertical wizard-circle mt-1" id="createScheduleForm"
                                          ...
                                          <div class="card-body">
                                              <div class="table-responsive">
                                                  <div class="row">
                                                      ...
                                                      <div class="col-md-3" id="makedescending" style="cursor: pointer;">
                                      ...
                                      <div class="row mt-3 CustomerAdderss" style="display: none">
                                          <div class="mb-2">
                                              ...
                                              <div class="form-group">
                                                  <input type="hidden" name="addres_lat" id="addres_lat"
                                                      value="">
                              ...
                              <section>
                                          ...
                                          <div class="mt-0 mb-3">
                                              ...
                                              <select class="form-control" name="job_titleSelect" id="job_title_select">
                                                  ...
                                                  @foreach ($jobTitle as $value)
                                                      <option value="{{ $value->field_name }}">{{ $value->field_name }}
                                                      </option>
                                                  @endforeach
                                              </select>
                                      ...
                                      <div class="col-md-6">
                                          <div class="mt-0 mb-3">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <small id="textHelp" class="form-text text-muted">All all details of
                                                      the
                                                      job goes here</small>
                                              </div>
                                          </div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="mt-0 mb-3">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <small id="textHelp" class="form-text text-muted">Technician will see
                                                      the
                                  ...
                                  <div class="row" style="display: none;" id="show_new_appl">
                                      ...
                                      <div class="col-md-3">
                                          <div class="mt-0 mb-3">
                                              <h6 class="card-title required-field"><i class="fas fa fa-hashtag"></i>
                                                  Model
                                                  Number </h6>
                                              <div class="form-group">
                                  ...
                                  <div class="container">
                                      ...
                                      <div id="serviceRows">
                                          ...
                                          <div class="row service-row">
                                              ...
                                              <div class="col-md-2">
                                                  <a type="button" class="text-danger remove-row"><i
                                                          class="ri-delete-bin-line ft15"></i> </a>
                                              </div>
                                          </div>
                                      </div>
                                  ...
                                  <div class="container mt-2">
                                      ...
                                      <div id="partsRows">
                                          ...
                                          <div class="row parts-row">
                                              ...
                                              <div class="col-md-2">
                                                  <a type="button" class="text-danger remove-part-row"><i
                                                          class="ri-delete-bin-line ft15"></i> </a>
                                              </div>
                                          </div>
                                      </div>
                                          ...
                                          <div class="confirm_job_box">
                                              ...
                                              <div class="row" style="border-top: 2px dotted #343434">
                                                  <div class="col-md-7 mt-2">
                                                      <div class="align-self-end d-flex">
                                                          <div>
                                                              ...
                                                              <p>Whether job confirmed from customer or not</p>
                                                          </div>
                                                      ...
                                                      <div class="align-self-end d-flex">
                                                          <div>
                                                              <h4> Do you want to Job Publish ?</h4>
                                                              <p>Publish the job on Schedule</p>
                                                          </div>

                                                          <div class="form-check form-switch ms-4">
                                                              <input class="form-check-input" name="is_published"
                                                                  type="checkbox" value="yes"
                                                                  id="flexSwitchCheckChecked">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="align-self-end d-flex">
                                                          <div>
                                                              <h4> Do you want to Show on Schedule ?</h4>
                                                              <p>Display the job on Schedule </p>
                                                          </div>

                                                          <div class="form-check form-switch ms-4">
                                                              <input class="form-check-input" name="show_on_schedule"
                                                                  type="checkbox" value="yes"
                                                                  id="flexSwitchCheckChecked">
                                                          </div>
                                                      </div>
                                                  ...
                                                  <div class="col-md-4 mt-2 text-right"
                                                      ...
                                                      <h5 style="display: inline-flex;">Tax:&nbsp;<div
                                                              class="taxcodetext">
                                                              $0</div>
                                                      </h5><br>
                                                      <h4 style="display: inline-flex;">Total:&nbsp;<div
                                                              class="totaltext">
                                                              $0</div>
                                                      </h4>
                                                  </div>
