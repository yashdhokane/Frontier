<div class="mt-3 mb-4 calender-sidebar app-calendar" id="calender2">
        ...
        <div class="col-md-4 text-start">
            <a id="selectDates2" style="margin-right: 10px; font-size: 13px;cursor: pointer;"><i
                    ...
                    <div class="btn-group my-2" role="group" aria-label="Button group with nested dropdown"
                        ...
                        <a href="#navCalendar2" class="btn btn-info cbtn2">Calendar</a>
                        <a href="#navMap2" class="btn btn-light-info text-info mbtn2">Map</a>
                    </div>
    ...
    <div class="dat schedule_section_box" id="scheduleSection2" data-map-date="{{ $formattedDate }}">
    ...
    <div class="col-12 bg-light py-2 px-3 mt-3 card-border mapStyle" id="mapSection2">
        <div id="mapScreen2" style="height: 550px !important; width: 100% !important;"></div>
    </div>
</div>
