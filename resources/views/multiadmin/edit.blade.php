                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="display_name" name="display_name"
                                            value="{{ old('display_name', $multiadmin->name) }}" placeholder=""
                                            required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" maxlength="10" class="form-control" id="mobile_phone"
                                            name="mobile_phone" value="{{ old('mobile_phone', $multiadmin->mobile) }}"
                                            placeholder="" required>
                                        <small id="name" class="form-text text-muted">Don’t add +1. Only add mobile
                                            number without space.</small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" maxlength="10" class="form-control" id="home_phone"
                                            name="home_phone" value="{{ $UsersDetails->home_phone }}" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" maxlength="10" class="form-control" id="work_phone"
                                            name="work_phone" value="{{ $UsersDetails->work_phone }}" placeholder="">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city"
                                        value="{{ $multiadmin->Location->city ?? null }}" oninput="searchCity()"
                                        required>
