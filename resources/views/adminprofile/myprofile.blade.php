            ...
            <div class="card">
                ...
                <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button
                            class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent2 fs-3 py-4"
                                        ...
                                        <div class="card w-100 position-relative overflow-hidden">
                                            <div class="card-body p-4">
                                                ...
                                                <div class="text-center">
                                                    {{-- <img
                                                        src="https://gaffis.in/frontier/webapp/design/assets/images/users/1.jpg"
                                                        alt="Default Preview" id="imagePreview"
                                                        class="img-fluid rounded-circle" width="120" height="120"> --}}
                                                    {{-- <div class="text-center"> --}}
                                                        @if(file_exists(public_path('images/' . $user->user_user)))
                                                        <img src="{{ asset('public/images/' . $user->user_image) }}"
                                                            alt="Default Preview" id="imagePreview"
                                                            class="img-fluid rounded-circle" width="120" height="120">
                                                        @else
