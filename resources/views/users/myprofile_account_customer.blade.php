<div class="row mt-12 ">
    ...
    <div class="col-md-9">
       ...
       @if(!is_null($setting) && $setting->email_notifications == 1) checked
       ...
       onchange="updateFormValues('emailSwitch', 'switch_email', this.checked)">
                            ...
                            <div class="d-flex align-items-center justify-content-between py-3 border-top mb-3">
                                ...
                                <div class="form-check form-switch mb-0">
                                    <input type="hidden" name="switch_sms"
                                        value="{{ $setting->sms_notification ?? null }}">
              <input class="form-check-input" type="checkbox" role="switch" id="smsSwitch" name="sms_switch"
       @if(!is_null($setting) && $setting->sms_notification == 1) checked
