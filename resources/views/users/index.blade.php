      ...
      <div class="card card-body">
        <div class="row">
          ...
          <div class="
            ...
            <a href="{{route('users.create')}}" id="" class="btn btn-info">
...
<br />
                ...
                <td class="action footable-last-visible" style="display: table-cell;">
                  <div class="action-btn" style="display:flex">
                    <a href="{{ route('users.show', $user->id) }}" class="text-info edit">
                      <span class="badge bg-info">
                        <i data-feather="eye" class="feather-sm fill-white"></i> View
                      </span>
                    </a>
                    <a href="{{ route('users.edit', $user->id) }}" class="text-info edit ms-2">
