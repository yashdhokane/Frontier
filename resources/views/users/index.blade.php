                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="state" name="state[]" class="select2 form-control custom-select"
                                    ...
                                    <option value="{{ $state->state_id }}" {{ in_array($state->state_id, $stateIds) ?
                                        'selected' : '' }}>
                                        {{ $state->state_name }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="jobs" name="jobs" class="select2 form-control custom-select"
                                    ...
                                    <option value="this_month" {{ $jobs==='this_month' ? 'selected' : '' }}>Jobs This
                                        Month
                                    </option>
                                    <option value="last_month" {{ $jobs==='last_month' ? 'selected' : '' }}>Jobs Last
                                        Month
                                    </option>
                                </select>
                            </div>
                                        ...
                                        <div class="user-meta-info">
                                            <a href="{{ route('users.show', $user->id) }}">
                                                ...
                                                <p id="showFlagDesc" class="pointer">
                                                    <span style="color:{{$user->FlagJob->flag_color ?? null}}"
                                                        title="{{$user->JobNoteModel->note ?? null}}">
    ...
    <span class="btn btn-secondary btn-sm">{{ $user->status }}</span>
                            ...
                            <td>
                                <div style="display:flex;" data-bs-toggle="modal" data-bs-target="#commentModal2"
                                    ...
                                    <span class="status_icons status_icon2"><i class="ri-close-line"></i></span> <span
