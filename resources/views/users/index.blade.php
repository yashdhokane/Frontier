      ...
      <div class="card card-body">
        <div class="row">
          ...
          <div class="col-md-8 col-xl-10 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
             <a href="{{route('users.create')}}" id="" class="btn btn-info"><i class=" fas fa-user-plus "></i> New Customer</a>
          </div>
        </div>
      </div>
      <!-- ---------------------
            ...
            <tbody>
              ...
              <tr class="search-items">
                 <td>
                  ...
                  @if($user->user_image)
                    <img src="{{ asset('public/images/customer/' . $user->user_image) }}" alt="avatar" class="rounded-circle"
                      width="45" />
                    @else
...
@endphp
    ...
    @if($userAddress)
         <span class="user-work text-muted">{{ $userAddresscity }}, {{ $userAddress->state_name }}, {{ $userAddress->zipcode }}</span>
    @else
...
<br />
                ...
                <td>
					<span class="mb-1 badge @if($user->status == 'deactive' ) { bg-danger } @else { bg-success } @endif">{{ $user->status }}</span>
				</td>
