...
.user-work, .user-name, .ucfirst, .pointer, .ri-close-line, .dropdown-toggle  {
    font-size: 10px;
}
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <div class="dropdown dropstart">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            <li>
                                <a href="{{ route('customers_demo_iframe_create') }}" id="newCustomerBtn"
                                    class="dropdown-item">
                                    <i class="ri-user-add-line"></i> Add New Customer
                                </a>
                            </li>
                            @if(request()->routeIs('customers_demo_iframe'))
                            <li>
                                <a href="{{ route('customers_demo_iframe.status', ['status' => 'deactive']) }}"
                                    class="dropdown-item">
                                    <i class="ri-user-unfollow-fill"></i> View Inactive Customers
                                </a>
                            </li>
                            @elseif(request()->routeIs('customers_demo_iframe.status'))
                            <li>
                                <a href="{{ route('customers_demo_iframe') }}" class="dropdown-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-xl-2">
                            ...
                            <select id="state" name="state[]" class="select2 form-control custom-select"
                                ...
                                <option value="{{ $state->state_id }}" {{ in_array($state->state_id, $stateIds) ? 'selected'
                                : '' }}>
                                    {{ $state->state_name }}
                                </option>
                                @endforeach
                        ...
                        <div class="col-md-2 col-xl-2">
                            ...
                            <select id="jobs" name="jobs" class="select2 form-control custom-select"
                                ...
                                <option value="upcoming" {{ $jobs==='upcoming' ? 'selected' : '' }}>Upcoming Jobs
                                </option>
                ...
                <div class="table-responsive table-custom">
                    ...
                    <table id="usersTable" class="table table-hover table-striped search-table v-middle"
                        ...
                        <tbody>
                            ...
                            <tr class="search-items">
                                ...
                                <td>
                                    <div style="display:flex;" data-bs-toggle="modal" data-bs-target="#commentModal2"
                                        ...
                                        <span class="px-2 mt-1 pointer">Not Updated</span>
                                        @elseif($user->is_updated == 'yes')
                                        <span class="status_icons status_icon1"><i class="ri-check-fill"></i></span>
                                        <span class="px-2 mt-1 pointer">Updated <span class="is_updated_time">{{
                                            $isEnd($user->updated_at)}}</span></span>
                                        @endif
                                    </div>
                            ...
                            <div class="modal fade" id="commentModal2" tabindex="-1" aria-labelledby="commentModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3 form-check">
                                                    <input type="checkbox"
                                                        ...
                                                        onchange="updateIsUpdated(this)" {{ $user->is_updated == "yes" ?
                                                'checked' : '' }}>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="comment" name="note"
                                                        rows="3"></textarea>
                                                </div>
                                            </div>
