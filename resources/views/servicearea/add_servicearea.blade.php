                ...
                <div class="row mt-4 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-group mb-3">
                            <input type="text" name="area_name" class="form-control" id="nametext"
                                aria-describedby="name" placeholder="Name" required>

                        </div>
                        <div class="form-group mb-3">
                            <textarea class="form-control" name="area_description" id="name1" placeholder="Description" required></textarea>
                        ...
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="area_latitude" id="name3"
                                aria-describedby="name" placeholder="Latitude" required>

                        </div>
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="area_longitude" id="name4"
                                aria-describedby="name" placeholder="Longitude"required>
