                ...
                <div class="form-container" style="display: none;">
                    <form action="{{ route('buisnessprofile.update') }}" method="post"
                        ...
                        <div class="form-group col-md-3 px-3">
                            ...
                            <input type="email" id="supportEmail" value="{{ $businessProfile->email }}"
                                name="supportEmail" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group col-md-3 px-3">
                            <label for="legalEntityName" class="control-label col-form-label bold mb5">Legal Entity Name</label>
                            <input type="text" id="legalEntityName" name="legal_name"
                                value="{{ $businessProfile->legal_name }}" class="form-control" required>
                        </div>

                        <div class="form-group col-md-3 px-3">
                            <label for="heatingAndAirConditioning" class="control-label col-form-label bold mb5">Heating & Air
                                Conditioning</label>
                                ...
                                <div class="form-group1 col-md-12" style="display:none; padding:7px;">
                                    <form action="{{ route('bpcompanydiscription.update') }}" method="post"
                                        ...
                                        <input type="hidden" name="id" value="{{ $businessProfile->id }}"
                                            required>
                                        <textarea id="description" class="form-control" name="description_long" required> {{ $businessProfile->description_long ?? null }}</textarea>
                        ...
                        <div class="row pt-4 pb-4 mt-5">
                            ...
                            <div class="form-group2 col-md-12" style="display:none; padding:7px;">
                                <form action="{{ route('moicompanydiscription.update') }}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $businessProfile->id }}" required>
                                    <textarea id="message_on_docs" class="form-control" name="message_on_docs" required> {{ $businessProfile->message_on_docs ?? null }}</textarea>
                        ...
                        <div class="row pt-4 pb-4 mt-3">
                            ...
                            <div class="form-group3 col-md-12" style="display:none; padding:7px;">
                                <form action="{{ route('taccompanydiscription.update') }}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $businessProfile->id }}" required>
                                    <textarea id="terms_condition" class="form-control" name="terms_condition" required> {{ $businessProfile->terms_condition ?? null }}</textarea>
