            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            class="fas fa-users" style="font-size: 16px;"></i> <span class="hide-menu">Profiles
                        </span></a>
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item"><a href="{{ route('technicians.index') }}" class="sidebar-link"><i
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#." aria-expanded="false"><i
                            data-feather="log-out" class="feather-icon"></i><span class="hide-menu">Log Out</span></a>
                </li>
                @endif
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            class="fas fa-chart-line" style="font-size: 16px;"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            class="fas far fa-sun" style="font-size: 16px;"></i>
