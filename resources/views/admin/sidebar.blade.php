                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('schedule') }}" class="sidebar-link"><i
                                            class="fas fa-calendar-check"></i><span class="hide-menu"> Schedule
                                        </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('map') }}" class="sidebar-link"><i
                                            class="fas fa-calendar-check"></i><span class="hide-menu"> Reschedule
                                        </span></a>
                                </li>
                ...
                <ul id="sidebarnav">
                    ...
                    @else
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="{{ route('tickets.index') }}"
                                        class="sidebar-link"><i class="mdi mdi-book-multiple"></i><span
                                            class="hide-menu"> Jobs List </span></a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="{{ route('product.index') }}"
                                        class="sidebar-link"><i class="mdi mdi-book-multiple"></i> <span
                                            class="hide-menu">
                                            Parts </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('assign_product') }}"
                                        class="sidebar-link"><i class="mdi mdi-book-multiple"></i> <span
                                            class="hide-menu">Assign Parts </span></a>
                                </li>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('performanncematrix') }}"
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="{{ route('businessHours.business-hours') }}"
                                        class="sidebar-link"><i class="mdi mdi-book-multiple"></i> <span
                                            class="hide-menu">
                                ...
                                <li class="sidebar-item"><a href="{{ route('tax.index') }}" class="sidebar-link"><i
                                            class="mdi mdi-book-multiple"></i> <span class="hide-menu"> Tax</span></a>
                                </li>

                                <li class="sidebar-item"><a href="{{ route('lead.lead-source') }}"
                                        class="sidebar-link"><i class="mdi mdi-book-multiple"></i> <span
                                            class="hide-menu"> Lead Source </span></a>
                                </li>
                                ...
                                <li class="sidebar-item"><a href="{{ route('site_job_fields') }}"
                                        class="sidebar-link"><i class="mdi mdi-book-multiple"></i> <span
                                            class="hide-menu"> Job Fields </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                ...
                <ul id="sidebarnav">
                    ...
                    @else
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('schedule') }}" class="sidebar-link"><i
                                            class="fas fa-calendar-check"></i><span class="hide-menu">
                                            Schedule </span></a></li>
                                    ...
                                    <li class="sidebar-item"><a href="#" class="sidebar-link">
                                            <span class="hide-menu">
                                                ...
                                                <div class="bg-white h-100" id="filterSchedule">
                                                    ...
                                                    <div>
                                                        <h4>TECHNICIAN</h4>
                                                        <input type="text" name="searchTechnician"
                                                            id="searchTechnician"
