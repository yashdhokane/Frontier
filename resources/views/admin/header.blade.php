        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown mega-dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark megamenutop1" role="button" href="#"
                        ...
                        <div class="mega-dropdown-menu row">
                            ...
                            <div class="col-lg-3 col-xl-2 mb-4">
                                ...
                                <ul class="list-style-none">
                                    <li><a href="https://gaffis.in/frontier/website/technicians"><i
                                                class="fas fa-user"></i> Technicians</a></li>
                                    <li><a href="https://gaffis.in/frontier/website/users"><i
                                                class="fas fa-user-plus"></i> Customers</a></li>
                                </ul>
                            </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-animate-up" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item"
                            href="https://gaffis.in/frontier/website/technicians/create">Technician</a>
...
<!-- Admin Sidebar -->
<!-- Add your admin-specific sidebar code here -->
<header class="topbar">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <div class="dropdown-menu dropdown-menu-animate-up">
                        <div class="mega-dropdown-menu row">
                            <div class="col-lg-3 mb-4">
                                ...
                                <ul class="list-style-none">
                                    <li><a href="https://gaffis.in/frontier/website/book-list/services"
                                            class="sidebar-link"><i class="mdi mdi-book-multiple"></i><span
                                                class="hide-menu"> Services </span></a></li>
                                    <li><a href="https://gaffis.in/frontier/website/book-list/productCategory"
                                            class="sidebar-link"><i class="mdi mdi-book-multiple"></i><span
                                                class="hide-menu"> Materials </span></a></li>
                                    <li><a href="https://gaffis.in/frontier/website/book-list/estimate"
                                            class="sidebar-link"><i class="mdi mdi-book-multiple"></i><span
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <ul class="list-style-none">
                                    <li><a href="https://gaffis.in/frontier/website/buisness-profile"
                                            class="sidebar-link"><i class="mdi mdi-book-multiple"></i><span
                                                class="hide-menu"> Profile
                                            </span></a></li>
                                    <li><a href="https://gaffis.in/frontier/website/businessHours/business-hours "
                                            class="sidebar-link"><i class="mdi mdi-book-multiple"></i><span
                                                class="hide-menu"> Business
                                                Hours </span></a></li>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="{{route('servicearea.index')}}"><i
                            class="far fa-sun" style="font-size: 20px;"></i> </a>
