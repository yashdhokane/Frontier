        ...
        <div class="col-5 align-self-center">
            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        {{-- <li class="breadcrumb-item"><a href="estimate-templates.html">Estimate templates</a>
                        </li>
                        <li class="breadcrumb-item"><a href="estimate-templates.html">Installation</a></li> --}}
            ...
            <div class="card card-body">
                ...
                <form action="{{ route('manufacture.update', ['id' => $manufacture->id]) }}" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="manufacturer_name" value="{{ $manufacture->manufacturer_name }}"
                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-8">
                            ...
                            <textarea id="text" name="manufacturer_description" class="form-control"
                                style="height: 180px;">{{ $manufacture->manufacturer_description }}
							</textarea>
                            <small id="textHelp" class="form-text text-muted"></small>
                        </div>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-4">
                            <label class="control-label"
                                ...
                                Image</label>
                            <input type="file" value="{{ $manufacture->manufacturer_image }}" name="manufacturer_image"
                                id=""
