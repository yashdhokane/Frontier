                ...
                <div class="col-5 align-self-center">
                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                {{-- <li class="breadcrumb-item"><a href="services-dashboard.html">Price Book</a></li>
                                --}}
                                <li class="breadcrumb-item"><a href="">Manufacturer List</a>
                                </li>
                        ...
                        <div class="card-body">
                            <h6 class="card-title">{{ $item->manufacturer_name }}<div
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            <form method="post"
                                                action="{{ route('manufacture.destroy', ['id' => $item->id]) }}">
                                                @csrf
                                                @method('DELETE')
