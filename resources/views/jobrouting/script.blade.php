    ...
    function initMap(techniciansData) {
        ...
        techniciansData.forEach((techData) => {
            ...
            const infoWindow = new google.maps.InfoWindow({
                content: `<h4 class="JobOpenModalButton pointer" data-tech-name="${name}" data-tech-id="${ techData.technician.id }">${name}</h4><p>${full_address}</p>`
            });
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.JobOpenModalButton', function(event) {
                ...
                `);
                            ...
                            initMap0(response.technician_location, response.sorted_customers);
