...
.dt-search {
    ...
    <div class="page-breadcrumb">
        <div class="row">
          @php
    $pageTitle = str_replace('_', ' ', request()->segment(count(request()->segments())));
@endphp

<div class="col-4 align-self-center">
    <h4 class="page-title">{{ ucwords($pageTitle) }}</h4>
	...
	*/
            ...
            <div class="card-body card-border shadow">
                ...
                <div class="row">
                    ...
                    @elseif($_REQUEST['type'] == 'average_job_size')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="monthjobRevenue">
                                    ...
                                    <tbody>
                                        @foreach ($monthJobs as $monthJob)
                                            ...
                                            ?>
                                            <tr data-month="{{ $monthJob->month }}" data-year="{{ $year }}"
                                ...
                                <table class="table table-hover table-striped customize-table mb-0 v-middle" id="job_count">
                                    ...
                                    <tbody>
                                        @foreach ($monthJobscount as $item)
                                            <tr data-date="{{ \Carbon\Carbon::parse($item->date)->format('Y-m-d') }}"
                                ...
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    ...
                                    <tbody>
                                        @foreach ($weekly as $item)
                                            ...
                                            ?>
                                            <tr data-week="{{ $item->week }}" data-year="{{ $year }}"
                                                data-month="{{ $startDate->month }}">
                                                <td>{{ $startDate->format('M d, Y') }} - {{ $endDate->format('M d, Y') }}
                                                </td>
                    ...
                    @elseif($_REQUEST['type'] == 'job_tags')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="job-tags-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="job_tags">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'job_fields')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="priority-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="priority">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'Status')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="status-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="status">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'job_lead_source')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="job_lead_source-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="job_lead_source">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'customer')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="customer-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="customerReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'zipcode')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="zipcode">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="zipcodeReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'city')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="city-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="cityReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'state')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="state-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="stateReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'manufacturers')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="manufacturers-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle "
                                    id="manufacturers">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'appliances')
                        <div class="col-md-12">
                            <div class="table-responsive table-custom2" id="appliances-div">
                                <table class="table table-hover table-striped customize-table mb-0 v-middle"
                                    id="appliances">
                                    <thead class="table-light">
                                        <tr>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("submitButton").addEventListener("click", function() {
                ...
                if (filterValue === "date_range") {
                    ...
                    const selectedDate = fromDateInput
                        .value; // Using "fromDate" as an example for date selection
            ...
            function filterByCreatedAt(rows, selectedDate) {
                rows.forEach(row => {
                    const createdAt = new Date(row.dataset
                        .createdAt); // Assuming data-created-at attribute exists
    ...
    <script>
        $(document).ready(function() {
            // Initialize DataTable (For Job Revenue)
            let jobRevenueTable = $('#jobRevenue').DataTable({
                "order": [
                    [0, "desc"]
                ], // Default sorting by the first column
            ...
            $('#dataFilter').on('change', function() {
                ...
                // Show the appropriate picker based on filter selection
                if (filterType === 'date_range') {
                    $('#dateRangePicker, #toDatePicker').show();
                } else if (filterType === 'month') {
                    $('#monthPicker').show();
            ...
            function fetchData() {
                ...
                let ajaxUrl = "{{ route('data_report.fetch') }}"; // Default URL

                // Set custom routes based on filter type
                if (filterTypeFromUrl) {
                    switch (filterTypeFromUrl) {
                        case 'Status':
                            ajaxUrl = "{{ route('data_report.status') }}";
                            break;
                        case 'job_tags':
                            ajaxUrl = "{{ route('data_report.job_tags') }}";
                            break;
                        case 'customer':
                            ajaxUrl = "{{ route('data_report.customer') }}";
                            break;
                        case 'zipcode':
                            ajaxUrl = "{{ route('data_report.zipcode') }}";
                            break;
                        case 'manufacturers':
                            ajaxUrl = "{{ route('data_report.manufacturers') }}";
                            break;
                        case 'appliances':
                            ajaxUrl = "{{ route('data_report.appliances') }}";
                            break;
                        case 'job_lead_source':
                            ajaxUrl = "{{ route('data_report.job_lead_source') }}";
                            break;

                        case 'job_fields':
                            ajaxUrl = "{{ route('data_report.priority') }}";
                            break;

                        case 'city':
                            ajaxUrl = "{{ route('data_report.city') }}";
                            break;
                        case 'state':
                            ajaxUrl = "{{ route('data_report.state') }}";
                            break;
                        default:
                            break;
                    }
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        // Show loading message based on filterTypeFromUrl
                    ...
                    success: function(response) {
                        ...
                        // Update the relevant div with the response content
                        if (filterTypeFromUrl === 'appliances') {
                            $('#appliances-div').html(response);
                            reinitializeDataTable('#appliances');
                        } else if (filterTypeFromUrl === 'job_tags') {
                            $('#job-tags-div').html(response);
                            reinitializeDataTable('#job_tags');
                        } else if (filterTypeFromUrl === 'zipcode') {
                            $('#zipcode').html(response);
                            reinitializeDataTable('#zipcodeReport');
                        } else if (filterTypeFromUrl === 'manufacturers') {
                            $('#manufacturers-div').html(response);
                            reinitializeDataTable('#manufacturers');
                        } else if (filterTypeFromUrl === 'customer') {
                            $('#customer-div').html(response);
                            reinitializeDataTable('#customerReport');
                        } else if (filterTypeFromUrl === 'job_lead_source') {
                            $('#job_lead_source-div').html(response);
                            reinitializeDataTable('#job_lead_source');
                        } else if (filterTypeFromUrl === 'job_fields') {
                            $('#priority-div').html(response);
                            reinitializeDataTable('#priority');
                        } else if (filterTypeFromUrl === 'city') {
                            $('#city-div').html(response);
                            reinitializeDataTable('#cityReport');
                        } else if (filterTypeFromUrl === 'state') {
                            $('#state-div').html(response);
                            reinitializeDataTable('#stateReport');
                        } else {
                            $('#dataTable').html(response);
                            reinitializeDataTable('#jobRevenue');
                        }
                    },
                    error: function() {
                        alert('An error occurred while fetching data.');
            ...
            // Reinitialize DataTable for dynamic content
