            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    @if ($_REQUEST['type'] == 'job_revenue')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="jobRevenue">
                    ...
                    @elseif($_REQUEST['type'] == 'average_job_size')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="monthjobRevenue">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'job_count')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="job_count">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="border-bottom border-top">Jobs by Scheduled Day </th>
                    ...
                    @elseif($_REQUEST['type'] == 'daily')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="daily">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="border-bottom border-top">Jobs by Scheduled Day </th>
                                            <th class="border-bottom border-top">Job Revenue</th>
                    ...
                    @elseif($_REQUEST['type'] == 'weekly')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="weekly">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="border-bottom border-top">Jobs by Month </th>
                                            <th class="border-bottom border-top">Job Revenue</th>
                    ...
                    @elseif($_REQUEST['type'] == 'monthly')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="monthly">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="border-bottom border-top">Jobs by Month </th>
                                            <th class="border-bottom border-top">Job Revenue</th>
                    ...
                    @elseif($_REQUEST['type'] == 'job_tags')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="job_tags">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'job_fields')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="priority">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'job_lead_source')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="job_lead_source">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'customer')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="customerReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'zipcode')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="zipcodeReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'city')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="cityReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'state')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="stateReport">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'manufacturers')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="manufacturers">
                                    <thead class="table-light">
                                        <tr>
                    ...
                    @elseif($_REQUEST['type'] == 'appliances')
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table customize-table mb-0 v-middle" id="appliances">
                                    <thead class="table-light">
                                        <tr>
