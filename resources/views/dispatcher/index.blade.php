                                ...
                                <td>
                                    <div class="n-chk align-self-center text-center">
                                        ...
                                        <td class="align-items-center ">
                                            {{ str_pad($user->employee_id, 4, '0', STR_PAD_LEFT) }}</td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    <div class="user-meta-info">
                                                        <a href="{{ route('dispatcher.show', $user->id) }}">
                                        ...
                                        'null'}}</span> --}}
                                            <div style="display:flex;">
                                                @if ($user)
                                                    ...
                                                    @if ($userAddress)
                                                        <span
                                                            class="user-work text-muted">{{ $userAddresscity ?? null }}</span>&nbsp;
                                                        <span class="user-work text-muted">,</span>

                                                        <span
                                                            class="user-work text-muted">{{ $userAddress->state_name }}</span>


                                                        <span class="user-work text-muted">,</span>
                                                        <span
                                                            class="user-work text-muted">{{ $userAddress->zipcode }}</span>
                                                    @else
                                            ...
                                            <div class="action-btn" style="display:flex">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="{{ route('dispatcher.show', $user->id) }}"><i
