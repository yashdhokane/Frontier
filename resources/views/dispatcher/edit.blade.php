            ...
            <div class="col-sm-9 col-md-9">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            <label for="first_name" class="control-label bold col-form-label required-field">First
                                Name</label>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            <label for="last_name" class="control-label bold col-form-label required-field">Last
                                Name</label>
                            <input type="text" class="form-control" id="last_name"
                                value="{{ $UsersDetails->last_name }}" name="last_name" placeholder="" />
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="display_name" name="display_name"
                                value="{{ $dispatcher->name }}" placeholder="" required />
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            <label for="additional_email" class="control-label bold col-form-label">Additional
                                Email</label>
                            <input type="email" class="form-control" id="additional_email" name="additional_email"
                                value="{{ $UsersDetails->additional_email }}" placeholder="" required />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" maxlength="10" class="form-control" id="mobile_phone"
                                name="mobile_phone" value="{{ $dispatcher->mobile }}" placeholder="" required />
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" maxlength="10" class="form-control" id="home_phone" name="home_phone"
                                value="{{ $UsersDetails->home_phone }}" placeholder="" />
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" maxlength="10" class="form-control" id="work_phone" name="work_phone"
                                value="{{ $UsersDetails->work_phone }}" placeholder="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="mb-3">
                            <label for="address1" class="control-label bold col-form-label required-field">Address Line
                                1</label>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            <label for="city" class="control-label bold col-form-label required-field">City</label>
                            {{-- <select class="form-select" id="city" name="city" required>
                                <option selected disabled value="">Select City...</option>
                            </select> --}}
                            <input type="text" class="form-control" id="city" name="city"
                                value="{{ $dispatcher->Location->city ?? null }}" oninput="searchCity()" required />
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="dob" name="dob" placeholder=""
                                value="{{ $UsersDetails->dob }}" />
                        </div>
                    </div>
                    <!-- License Number -->
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            <label for="license_number" class="control-label bold col-form-label">License Number</label>
                            <input type="text" class="form-control" id="license_number" name="license_number"
                                placeholder="" value="{{ $UsersDetails->license_number }}" />
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input type="file" class="form-control" id="image"
                            value="{{ old('image', $dispatcher->user_image) }}" name="image" accept="image/*" />
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
