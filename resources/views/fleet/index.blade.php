...
@endif
    ...
    <table id="zero_config00" class="table table-hover table-striped text-nowrap" style="overflow-x: auto; overflow-y: auto;" data-paging="true" data-paging-size="7">
        <thead>
            <tr>
                <th>Vehicle</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ Str::limit($item->vehicle_description, 50) ?? null }}{{ strlen($item->vehicle_description) > 200 ? '...' : '' }}</td>
                <td>{{ Str::limit($item->vehicle_summary, 50) ?? null }}{{ strlen($item->vehicle_summary) > 200 ? '...' : '' }}</td>
                ...
                <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu">
                                                        ...
                                                        @endif
                                                        @if ($item->vehicle_id)
    <a href="{{ route('fleet.fleetedit', ['id' => $item->vehicle_id]) }}" class="text-dark pe-2 dropdown-item">
