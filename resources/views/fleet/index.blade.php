                        ...
                        <tr data-technician="{{ $item->technician->name ?? '' }}" data-status="{{ $item->status }}">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    @else
                                    <img src="{{ asset('public/images/vehicle.jfif') }}" alt="{{ $item->vehicle_name }}"
                            ...
                            <td>
                                <div>
                                    ...
                                    <div class="modal fade" id="samedata-modal-{{ $item->vehicle_id }}" tabindex="-1"
                            ...
                            <td>{{ $item->updated_at ? \Carbon\Carbon::parse($item->updated_at)->format('m-d-Y h:i:a') :
                                null }}
                            </td>
