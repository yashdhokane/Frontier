            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <form method="post" id="form2"
                        action="{{ route('vehicle_insurance_policy.update', ['id' => $policy->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-2">
                                        ...
                                        <input name="vehicle_name" id="vehicle_name"
                                            value="{{ $fleetModel->vehicle_name ?? '' }}" class="form-control" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-2">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2 ">
                                        ...
                                        <input class="form-control" type="text" value="{{ $fleetModel->make ?? '' }}"
                                            name="make" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2 ">
                                        ...
                                        <input class="form-control" type="text" value="{{ $fleetModel->year ?? '' }}"
                                            name="year" />
                                    </div>
                                </div>
                                <div class="col-md-6">
