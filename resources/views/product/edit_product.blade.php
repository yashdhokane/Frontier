                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="weight"
                                                        value="{{ old('weight', $weight) }}" class="form-control"
                                                        placeholder="" />
                                                </td>
                                            </tr>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="discount" class="form-control"
                                                    value="{{ $product->discount }}" placeholder=""
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select id="productAssignmentSelect" name="assigned_to" class="form-select"
                                                ...
                                                <option value="pending" @if ($product->assigned_to == 'pending') selected @endif>
                                                    Please select
                                                </option>
                                                <option value="all" @if ($product->assigned_to == 'all') selected @endif>
                                                    All
                                                    Technicians</option>
                                                <option value="selected" @if ($product->assigned_to == 'selected') selected @endif>
