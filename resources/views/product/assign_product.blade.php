                                ...
                                <div class="mb-2">
                                    <div class="card">
                                        <div class="card-body text-left">
                                            <h4 class="card-title mb-2">{{ $item->product_name }}</h4>
                                            <h6 class="mb-2">Assigned to </h6>
                                            <ul class="list-group list-group-horizontal-xl">

                                                @foreach ($assign->where('product_id', $item->product_id) as $assignment)

                                                    <li class="list-group-item d-flex align-items-center"><i
                                                            class="text-info fas fa-user mx-2"></i> {{ $assignment->Technician->name ?? null}}
                                                    </li>
