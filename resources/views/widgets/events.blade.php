...
<iframe src="https://dispatchannel.com/portal/events-iframe?header=off&sidebar=off"
    style="width: 100%; height: 400px; border: none; overflow-x: auto; overflow-y: auto;" id="eventsIframe">
</iframe>
{{-- </div>
        </div>
    </div>
