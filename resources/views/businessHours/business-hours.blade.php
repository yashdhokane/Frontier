                        ...
                        <div class="form_fields">
                            <div class="row mb-2">
                                <div class="col-4 py-2 px-3">
                                    ...
                                    <input type="time" name="day[{{ $hours->day }}][start]" class="form-control"
                                        id="stime" value="{{ $hours->start_time }}" />
                                </div>
                                <div class="col-4 py-2 px-3">
                                    <label for="stime"
                                        class="col-sm-4 text-start control-label col-form-label">End</label>
                                    <input type="time" name="day[{{ $hours->day }}][end]" class="form-control"
                                        id="stime" value="{{ $hours->end_time }}" />
                                </div>
                                <div class="col-4 py-2 px-3">
                                    <label for="stime"
                                        class="col-sm-4 text-start control-label col-form-label">Status</label>
                                    <div class="col-6 form-check">
                                        <input type="radio" id="customRadio3" name="day[{{ $hours->day }}][status]"
                                            class="form-check-input" value="on" {{ $hours->open_close === 'open' ?
                                        'checked' : '' }} />
                                        <label class="form-check-label" for="customRadio3">Open</label>
                                    </div>
                                    <div class="col-6 form-check">
                                        <input type="radio" id="customRadio3" name="day[{{ $hours->day }}][status]"
                                            class="form-check-input" value="off" {{ $hours->open_close === 'close' ?
                                        'checked' : '' }} />
                            ...
                            <div class="row mb-2">
                                <div class="col-4 py-2 px-3">
                                    <label for="stime"
                                        class="col-sm-4 text-start control-label col-form-label">Start</label>
                                    <input type="time" name="day[{{ $hours->day }}][start]" class="form-control"
                                        id="stime" value="{{ $hours->booking_start_time }}" />
                                </div>
                                <div class="col-4 py-2 px-3">
                                    <label for="stime"
                                        class="col-sm-4 text-start control-label col-form-label">End</label>
                                    <input type="time" name="day[{{ $hours->day }}][end]" class="form-control"
                                        id="stime" value="{{ $hours->booking_end_time }}" />
                                </div>
                                <div class="col-4 py-2 px-3">
                                    <label for="stime"
                                        class="col-sm-4 text-start control-label col-form-label">Status</label>
                                    <div class="col-6 form-check">
                                        <input type="radio" id="customRadio3" name="day[{{ $hours->day }}][status]"
                                            class="form-check-input" value="on" {{ $hours->booking_open_close === 'open'
                                        ? 'checked' : '' }} />
                                        <label class="form-check-label" for="customRadio3">Open</label>
                                    </div>
                                    <div class="col-6 form-check">
                                        <input type="radio" id="customRadio3" name="day[{{ $hours->day }}][status]"
                                            class="form-check-input" value="off" {{ $hours->booking_open_close ===
                                        'close' ? 'checked' : '' }} />
                                        <label class="form-check-label" for="customRadio3">Closed</label>
                                    </div>
                                </div>
