...
@keyframes glow {
    0% { box-shadow: 0 0 10px rgba(41, 98, 255, 0.7); }
    50% { box-shadow: 0 0 20px rgba(41, 98, 255, 0.7); }
    100% { box-shadow: 0 0 10px rgba(41, 98, 255, 0.7); }
}

.highlight-field {
    border: 2px solid #2962ff !important; /* Blue border */
    animation: glow 1.5s infinite alternate; /* Blue glow effect */
}
...
<div class="page-breadcrumb pt-2">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <div class="btn-group select-type-values float-end" role="group" aria-label="Button group with nested dropdown">
