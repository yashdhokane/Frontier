                    ...
                    <div class="card-body card-border shadow">
                        <div class="">
                            <h5 class="card-title uppercase mt-1 mb-2"><a class="text-dark"
                                    href="{{ url('users/show/' . $technicians->user->id) }}">{{ $technicians->user->name
                                    ?? null }}</a>
                            </h5>
                            <div>Address</div>
                ...
                <div class="card">
                    <div class="card-body card-border shadow text-center">
                        ...
                        <div class="profile-pic mb-3 mt-3">
                            ...
                            <a href="mailto:{{ $technicians->usertechnician->email ?? '' }}">{{
                                $technicians->usertechnician->email ?? null }}</a><br><small class="text-muted">{{
                                $technicians->usertechnician->mobile ?? null }}<br />{{
                                $technicians->usertechnician->Locationareaname->area_name ?? null }}</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body card-border shadow text-center">
                        ...
                        <div class="profile-pic mb-3 mt-3">
                            ...
                            <a href="mailto:{{ $technicians->addedby->email ?? '' }}">{{ $technicians->addedby->email ??
                                null }}</a><br><small class="text-muted">{{ $technicians->addedby->mobile ?? null
                                }}<br>Frontier Support
                                Staff</small>
                        </div>
                    </div>
                            ...
                            <div class="col-md-7">
                                <div class="mb-2">
                                    <h5 class="card-title uppercase">#{{ $technicians->id ?? null }} -
                                        {{ $technicians->job_title ?? null }} <span class="mb-1 badge bg-warning">{{
                                            $technicians->status ?? null }} </span>
                                    </h5>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="mb-2">
                                    <h5 class="card-title uppercase"><i class="fa fa-calendar" aria-hidden="true"></i>
                                        {{ \Carbon\Carbon::parse($technicians->jobassignname->start_date_time ??
                                        null)->format('jS F Y, h:i A') }}
                                    </h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-2"><strong>Date:
                                    </strong>{{ \Carbon\Carbon::parse($technicians->jobassignname->start_date_time ??
                                    null)->format('jS F Y') }}
                                </div>
                                <div class="mb-2"><strong>From:
                                    </strong>{{ $convertTimeToTimezone($technicians->JobAssign->start_date_time ?? null,
                                    'H:i:a') }}
                                </div>
                                <div class="mb-2"><strong>To:
                                    </strong>{{ $convertTimeToTimezone($technicians->JobAssign->end_date_time ?? null,
                                    'H:i:a') }}
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled mt-3">
                                    <li class="d-flex align-items-start">
                                        ...
                                        <img class="me-3 rounded"
                                            ...
                                            onerror="this.onerror=null; this.src='{{ $defaultImage }}';" />
                                        @else
                                        <img class="me-3 rounded" src="{{ $defaultImage }}" width="60" alt="image" />
                                        @endisset
                ...
                <div class="mb-4">
                    <div class="card">
                        <div class="card-body card-border shadow">
                            <div class="row mb-3 open_items">
                                ...
                                <div class="col-md-5 text-center">
                                    <form action="{{ route('create.payment.invoice') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn waves-effect waves-light btn-primary">View &
                                            Send
                                            Invoice</button>
                                    </form>
                                </div>
                            ...
                            <div class="row mb-3">
                                @if ($technicians->invoice_status == 'created' || $technicians->invoice_status ==
                                'complete')
                                <div class="col-md-12">
                                    <table class="table">
                                        <thead>
