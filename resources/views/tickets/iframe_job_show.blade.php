     ...
     <div class="card threedottest" style="display:block;">
            <div class="row card-body">
                ...
                <div class="col-10 align-self-center">
                    <h4 class="page-title1">#{{ $technicians->id ?? null }} - <span
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="dropdown dropstart">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                <li>
                                    <a href="{{route('tickets.indexiframe')}}" id="" class="dropdown-item">
                                       </i> Back
                                    </a>
                                </li>
                                <li>
                                 <a class="job_set_lnk ft14 dropdown-item" id="job_set_lnk" href="#."><i class="far fa-sun"></i> Job Settings</a>
                                </li>
                            </ul>
                        </div>
                    </div>
