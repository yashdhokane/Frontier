<div class="card text-white bg-light">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('productcategory.update') }}" method="post" class="form-horizontal form-material"
                ...
                <div class="col-md-12 mb-3">
                    <div class="
                        ...
                        <span><i class="ri-upload-line align-middle me-1 m-r-5"></i>Upload
                            Category Image</span>
                        <input type="file" value="{{ $productCategory->category_image }}" name="category_image"
                            class="upload" />
                    </div>
                </div>
            </div>
