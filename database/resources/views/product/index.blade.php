...
<div class="page-wrapper" style="display:inline;">
    ...
    <div class="page-breadcrumb" style="padding-top: 0px;">
        <div class="row">
            ...
            <div class="col-5 text-end mx-3">
				<a href="javascript:void(0)" id="btn-show-categories" class="btn btn-primary mx-3" ><i class="fas fa-plus "></i> New Part</a>
				<a href="javascript:void(0)" id="btn-show-categories" class="btn btn-info" ><i class="fas fa-eye"></i> Part Categories</a> 
			</div>
        </div>
    </div>
    @if(session('success'))
  ...
  <a href="{{ route('product.listingproduct', ['product_id' => $item->id]) }}">
  
                            @if($item->category_image)

        <img class="card-img-top img-responsive" src="{{ asset('public/images/' . $item->category_image) }}" style="width:228.5px; height:200px;" alt="Card image cap" />
    @else
        <img class="card-img-top img-responsive"  src="{{ asset('public/images/Noimage.png') }}" style="width:228.5px; height:200px;" alt="Default Image" />
    @endif
</a>
