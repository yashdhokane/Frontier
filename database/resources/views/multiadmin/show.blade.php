            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                ...
                <div class="card">
                        ...
                        <div class="row text-left justify-content-md-left">
                            ...
                            <div class="col-6">
                                ...
                                <h6>{{ $multiadmin->created_at ?
                                    \Carbon\Carbon::parse($multiadmin->created_at)->format('m-d-Y') : null }}</h6>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-12">
                                ...
                                <h6 style="font-weight: normal;"><i class="fas fa-envelope"></i> {{$multiadmin->email}}
                                </h6>
                            </div>
                            <div class="col-12">
					...
					{{-- 			<h4 class=" card-title mt-4">Lead Source</h4>
                                <div class="mt-0">
                                    <span class="mb-1 badge bg-primary">{{$multiadmin->leadsourcename->source_name ??
                                        null }}</span>
                                </div> --}}
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <center class="mt-1">
                                                    ...
                                                    <img src="{{ asset('public/images/admin/' . $multiadmin->id . '/' . $multiadmin->user_image) }}"
